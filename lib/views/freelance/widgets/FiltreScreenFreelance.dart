...
class FilterScreenFreelance extends StatefulWidget {
  const FilterScreenFreelance({super.key});

  @override
  State<FilterScreenFreelance> createState() => _FilterScreenFreelanceState();
}

class _FilterScreenFreelanceState extends State<FilterScreenFreelance> {
